// Type definitions for Swiper 5.1
...
export default class Swiper {
     ...
     * Add event listener
     */
    on<K extends keyof EventsOptions>(event: K, handler: EventsOptions[K]): void;

    /**
     * Add event listener that will be executed only once
     */
    once<K extends keyof EventsOptions>(event: K, handler: EventsOptions[K]): void;

    /**
     * Remove event listener for specified event
     * If no handler specified, removes all listeners for specified event
     */
    off<K extends keyof EventsOptions>(event: K, handler?: EventsOptions[K]): void;
